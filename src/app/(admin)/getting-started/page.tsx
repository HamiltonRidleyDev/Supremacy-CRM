...
const workflows: Workflow[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        detail: "AI-generated messages for lapsed members and families. Grouped by household so you send one message per parent, not one per kid. Approve, edit, or dismiss.",
      },
      {
        page: "Student Detail > Conversations",
        href: "/students",
        action: "Check message history before calling",
        detail: "See what was already sent (automated or manual) so you don't repeat yourself. The AI win-back prompt uses this context too.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        detail: "Voice or text capture for lesson ideas, technique variations, or student observations. Notes can feed directly into the Mat Planner as context.",
      },
    ],
  },
  {
...
const pages: PageInfo[] = [
  ...
  },
  {
    name: "Quick Notes",
    href: "/notes",
    description: "Voice or text capture for ideas, observations, and lesson concepts. Notes can feed into the Mat Planner as context. Tags for organization.",
    dataSource: "Our notes system",
    bestFor: ["Rodrigo (capturing ideas between classes)", "Post-class observations"],
  },
  {
    name: "Community",
    href: "/community",
